...
class AppetiteLossPage extends StatelessWidget {
  @override
...
class _BodyState extends State<Body> {
  ...
  void postAppetiteLoss() {
    var post = new Post(
        "LOSS OF APPETITE", "Loss of Appetite", new DateTime.now().toString());
                ...
                new Container(
                    ...
                    decoration: BoxDecoration(
                        image: DecorationImage(
                            alignment: Alignment.topCenter,
                            image: AssetImage(
                                'assets/images/appetiteHeader.png')))),
                new Padding(
                        ...
                        child: Column(children: <Widget>[
                          new Container(
                            ...
                            children: <Widget>[
                              ...
                              new Container(
                                padding: EdgeInsets.fromLTRB(32, 120, 40, 1),
                                child: Text(
                                  "Loss of appetite means you don't have the same desire to eat as you used to. Signs of decreased appetite include not wanting to eat, unintentional weight loss, and not feeling hungry. ",
                                  style: TextStyle(
                                      ...
                                      child: Column(
                                        ...
                                        children: <Widget>[
                                          Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                "Click the check button if you are experiencing loss of appetite",
                                                style: TextStyle(
                                                  fontWeight: FontWeight.bold,
                                                  fontSize: 20,
                                                  color: Colors.black,
                                          ...
                                          Container(
                                              ...
                                              child: Row(children: <Widget>[
                                                ClipRect(
                                                  ...
                                                  child: TextButton(
                                                    onPressed:
                                                        this.postAppetiteLoss,
                                                    child: Container(),
                                                  ),
                                                )),
                                                SizedBox(width: 20),
                                                Text(
                                                  "I am experiencing loss of appetite.",
                                                  style: TextStyle(
                                                    fontSize: 16,
                                                    color: Colors.black,
                                                  ),
